...
from app.services.nubra_ws_proto import (
    GenericData as FallbackGenericData,
    BatchWebSocketIndexMessage as FallbackBatchWebSocketIndexMessage,
    BatchWebSocketOrderbookMessage as FallbackBatchWebSocketOrderbookMessage,
)
...
try:
    from nubra_python_sdk.protos import nubrafrontend_pb2  # type: ignore

    GenericData = nubrafrontend_pb2.GenericData
    BatchWebSocketIndexMessage = nubrafrontend_pb2.BatchWebSocketIndexMessage
    BatchWebSocketOrderbookMessage = nubrafrontend_pb2.BatchWebSocketOrderbookMessage
except ModuleNotFoundError:
    GenericData = FallbackGenericData
    BatchWebSocketIndexMessage = FallbackBatchWebSocketIndexMessage
    BatchWebSocketOrderbookMessage = FallbackBatchWebSocketOrderbookMessage
